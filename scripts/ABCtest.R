...
pt_chain = mdl_run(pt_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
pt_output = mdl_process(pt_input, pt_chain)
pm_chain = mdl_run(pm_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
pm_output = mdl_process(pm_input, pm_chain)
pf_chain = mdl_run(pf_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
pf_output = mdl_process(pf_input, pf_chain)
lt_chain = mdl_run(lt_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
lt_output = mdl_process(lt_input, lt_chain)
lm_chain = mdl_run(lm_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
lm_output = mdl_process(lm_input, lm_chain)
lf_chain = mdl_run(lf_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
lf_output = mdl_process(lf_input, lf_chain)
ut_chain = mdl_run(ut_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
ut_output = mdl_process(ut_input, ut_chain)
um_chain = mdl_run(um_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
um_output = mdl_process(um_input, um_chain)
uf_chain = mdl_run(uf_input, chain_nr = 1, model = abc_mod, nchains=1, nburn=4000, niter=4000, nthin=1)
